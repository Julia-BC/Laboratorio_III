...
<body>
  <div class="container">
    ...
    <div class="right-side">
      ...
      <form class="form-cadastro" action="cadastro.html" method="POST">
  <div>
  ...
  <div id="form-empresa" style="display: none;">
    ...
    <input type="password" id="senhaEmpresa" name="senhaEmpresa" placeholder="Digite sua senha da empresa">
    <input type="password" id="confirmarSenhaEmpresa" name="confirmarSenhaEmpresa" placeholder="Confirme sua senha da empresa">
  </div>
